...
public class GbtFloat8Union extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", DefaultDataType.getDefaultDataType("\"public\".\"gbtreekey16\""), false, false);
    ...
    public GbtFloat8Union() {
        super("gbt_float8_union", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"gbtreekey16\""));
