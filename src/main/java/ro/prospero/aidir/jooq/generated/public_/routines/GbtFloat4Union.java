...
public class GbtFloat4Union extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", DefaultDataType.getDefaultDataType("\"public\".\"gbtreekey8\""), false, false);
    ...
    public GbtFloat4Union() {
        super("gbt_float4_union", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"gbtreekey8\""));
