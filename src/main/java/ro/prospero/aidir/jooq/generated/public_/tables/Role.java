...
public class Role extends TableImpl<RoleRecord> {
     ...
     */
    public final TableField<RoleRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>public.role.description</code>.
     */
    public final TableField<RoleRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR, this, "");
    ...
    public AccountPath account() {
        if (_account == null)
            _account = new AccountPath(this, null, Keys.ACCOUNT__ACCOUNT_ROLE_FKEY.getInverseKey());
    ...
    public RolePermissionPath rolePermission() {
        if (_rolePermission == null)
            _rolePermission = new RolePermissionPath(this, null, Keys.ROLE_PERMISSION__ROLE_PERMISSION_ROLE_FKEY.getInverseKey());
