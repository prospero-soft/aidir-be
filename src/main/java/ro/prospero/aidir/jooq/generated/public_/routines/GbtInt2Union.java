...
public class GbtInt2Union extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", DefaultDataType.getDefaultDataType("\"public\".\"gbtreekey4\""), false, false);
     ...
     */
    public GbtInt2Union() {
        super("gbt_int2_union", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"gbtreekey4\""));
